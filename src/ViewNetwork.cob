...
77 WS-RETURN-TO-MENU-CHOICE         PIC X VALUE SPACE.
77 WS-LOG-TEXT                      PIC X(300) VALUE SPACES.
77 WS-RETURN-CHOICE-LENGTH          PIC 9(4) VALUE 1.
01 WS-PROFILE-TABLE.
...
MAIN.
    ...
    MOVE "--- Your Network ---" TO WS-LOG-TEXT
    ...
    IF WS-CONNECTION-COUNT = 0
        ...
        MOVE "You have no established connections." TO WS-LOG-TEXT
        CALL "TestOutput" USING "A" WS-LOG-TEXT
    ELSE
    ...
    MOVE "1. Return to Main Menu" TO WS-LOG-TEXT
    CALL "TestOutput" USING "A" WS-LOG-TEXT
    DISPLAY "Enter your choice:"
    MOVE "Enter your choice:" TO WS-LOG-TEXT
    CALL "TestOutput" USING "A" WS-LOG-TEXT
    CALL "TestInput" USING WS-RETURN-CHOICE-LENGTH WS-RETURN-TO-MENU-CHOICE
    DISPLAY FUNCTION TRIM(WS-RETURN-TO-MENU-CHOICE)
    MOVE SPACES TO WS-LOG-TEXT
    STRING FUNCTION TRIM(WS-RETURN-TO-MENU-CHOICE) DELIMITED BY SIZE INTO WS-LOG-TEXT END-STRING
    CALL "TestOutput" USING "A" WS-LOG-TEXT
    IF WS-RETURN-TO-MENU-CHOICE NOT = "1"
        DISPLAY "Returning to Main Menu."
        MOVE "Returning to Main Menu." TO WS-LOG-TEXT
        CALL "TestOutput" USING "A" WS-LOG-TEXT
    END-IF
    GOBACK.
...
LOAD-PROFILE-DATA.
    ...
    IF WS-PROFILE-FILE-STATUS NOT = "00"
        IF WS-PROFILE-FILE-STATUS NOT = "35"
            ...
            MOVE SPACES TO WS-LOG-TEXT
            STRING "Error opening profiles.dat: " DELIMITED BY SIZE WS-PROFILE-FILE-STATUS DELIMITED BY SIZE INTO WS-LOG-TEXT END-STRING
            CALL "TestOutput" USING "A" WS-LOG-TEXT
        END-IF
        EXIT PARAGRAPH
    END-IF
...
LOAD-USER-CONNECTIONS.
    ...
    IF WS-CONNECTIONS-FILE-STATUS NOT = "00"
        ...
        MOVE SPACES TO WS-LOG-TEXT
        STRING "Error opening EstablishedConnections.dat: " DELIMITED BY SIZE WS-CONNECTIONS-FILE-STATUS DELIMITED BY SIZE INTO WS-LOG-TEXT END-STRING
        CALL "TestOutput" USING "A" WS-LOG-TEXT
        EXIT PARAGRAPH
    END-IF
...
DISPLAY-SINGLE-CONNECTION.
    ...
    MOVE SPACES TO WS-LOG-TEXT
    STRING FUNCTION TRIM(WS-NETWORK-LINE) DELIMITED BY SIZE INTO WS-LOG-TEXT END-STRING
    CALL "TestOutput" USING "A" WS-LOG-TEXT.
